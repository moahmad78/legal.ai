...
export function SignupModal() {
  ...
  useEffect(() => {
    if (isSignupModalOpen) {
      console.log("Analytics: signup_prompt_shown", { message: signupModalMessage });
    }
  }, [isSignupModalOpen, signupModalMessage]);
    ...
    <Dialog open={isSignupModalOpen} onOpenChange={(open) => !open && closeSignupModal()}>
      <DialogContent className="sm:max-w-md p-6">
        ...
        <div className="flex flex-col gap-3">
          <Link href="/sign-up" onClick={() => console.log("Analytics: signup_completed")}>
