...
export function GuestSidebar({ isCollapsed = false, onToggle, onCloseMobile, isMobile = false }: SidebarProps) {
  ...
  return (
    <aside className={cn("border-r bg-muted/30 flex flex-col h-full z-10 shrink-0", isMobile ? "w-full" : "w-[260px]")}>
